...
from .linknet_head import LinkNetHead, LinkNetHead_Multi
from .birenet_head import BireNetHead, BireNetAnxiliaryHead
...
__all__ = [
    ...
    'LinkNetHead', 'BireNetHead', 'BireNetAnxiliaryHead', 'LinkNetHead_Multi'
]
