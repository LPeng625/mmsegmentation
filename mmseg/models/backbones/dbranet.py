...
class DBRANet(nn.Module):
    def __init__(self, out_channels=2, pool_size=4):
        ...
        top_residual_branch.load_state_dict(torch.load('pre_trained_weights/resnet34-b627a593.pth'))
        bottom_refinedasymmetric_branch = RefinedAsymmetricBlock()
        ...
        self.finalconv2 = nn.Conv2d(32, 32, 3)
        self.finalrelu2 = nonlinearity
        self.finalconv3 = nn.Conv2d(32, out_channels, 2, padding=1)
